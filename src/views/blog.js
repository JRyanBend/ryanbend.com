    ...
    render: function() {
        return (
            <div className="page">
	       		...
	       		<p>So I've been rewriting my personal website in React to help build up my familiarity with it. This is happening in real time kind of, this blog will temporaily just be me blogging about my progress building the site in real time.</p>
	       		...
	       		<p>In the meantime I'll be building out the basic structure of the site, creating componenets for reusable assets, and experimenting with the page/folder structures to come up with something that works well.</p>
